...
echo "Running DTEC Fusion with LaplaceLoss and vlbi_loss_weight 1000.0"
python src/train.py --debug False --year 2023 --doy 010 --mode DTEC_Fusion --loss_fn LaplaceLoss --vlbi_loss_weight 1000.0
python src/inference_map.py --debug False --year 2023 --doy 010 --mode DTEC_Fusion --loss_fn LaplaceLoss --vlbi_loss_weight 1000.0
