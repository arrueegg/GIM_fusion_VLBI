...
def analyze_day_availability(experiments_folder='/scratch2/arrueegg/WP2/GIM_fusion_VLBI/experiments/'):
    ...
    report_lines.extend([
        ...
        "",
        "WHY 224 DAYS?",
        "  You trained models for 224 unique days throughout 2023, from DOY 003",
        "  (Jan 3) to DOY 363 (Dec 29). Not every day was trained - you focused",
        "  on days with VLBI sessions, which typically occur on weekdays.",
        "",
        "WHY WERE 20 DAYS EXCLUDED?",
        "  These 20 days are missing the Jason-3 satellite altimetry (SA) evaluation.",
        "  The SA evaluation compares your models against independent Jason-3",
        "  measurements. Possible reasons for missing SA evaluation:",
        "    • No Jason-3 satellite pass on that day over the region",
        "    • Jason-3 data not available/downloaded for that day",
        "    • SA evaluation script was not run for those days",
        "  ",
        "  Note: The models were trained successfully for all 224 days, but only",
        "  204 days have the complete evaluation including Jason-3 comparison.",
        "",
        "="*80,
