...
def plot(vtec_data, std_data):
    ...
    vtec_plot = ax1.pcolormesh(lon_range, lat_range, vtec_data, shading='auto', cmap='viridis', transform=ccrs.PlateCarree())
    ax1.coastlines()
    ...
    std_plot = ax2.pcolormesh(lon_range, lat_range, std_data, shading='auto', cmap='viridis', transform=ccrs.PlateCarree())
    ax2.coastlines()
